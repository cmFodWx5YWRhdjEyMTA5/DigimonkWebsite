                ...
                <div class="widget-content">
                            ...
                            <div class="col-md-6">
                                <?php if(@$_GET['delete']) { ?>
                                 <div class="alert alert-success alert-dismissible">
                                      <a href="our-expert-list.php" class="close">&times;</a>
                 ...
                 <div class="col-md-6">
                    <div class="data-align-right">
                       ...
                       <ul>
                       <li>
                        <a href="#" onclick="$('#exportable-tbl').tableExport({type:'excel',escape:'false'});" class="btn btn-info">
                       ...
                       <li><a href="#" onclick="$('#exportable-tbl').tableExport({type:'pdf',pdfFontSize:'7',escape:'false'});"> <i class="fa fa-file-pdf-o"></i> PDF</a></li>
                                ...
                                <li><a id="get_ids_for_expert_delete" class="btn add-row btn-danger">
                                <i class="fa fa-trash"></i> Delete</a></li>
                             
                               </ul>
                           <!--  <ul>
                               <li><a id="get_ids_for_delete" class="btn add-row btn-danger">
                                <i class="fa fa-trash"></i> Delete</a></li>
                            </ul> -->
                        </div>
                    </div>
                    ...
                    <table id="exportable-tbl" class="table table-striped data-tbl">
                        ...
                        <?php
                            $contact_query = mysqli_query($conn,"SELECT * FROM our_expert ORDER BY id DESC");
                            $sno = 1;
