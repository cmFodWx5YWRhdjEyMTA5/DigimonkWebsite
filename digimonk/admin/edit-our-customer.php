...
<div class="container-fluid">
        ...
        <div class="row">
         ...
         <?php
                ...
                $query = mysqli_query($conn,"SELECT * FROM our_customer WHERE id='".$id."'");
              ...
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="edit-our-customer.php" class="close">&times;</a>
                     ...
                     <div class="form-content">
                        <div class="row">
                          ...
                          <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="text" placeholder="Enter Title" id="title" name="title" value="<?php echo $row['title'];?>">
                              </div>
                          </div>
                          ...
                          <!-- <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter Facebook Url" id="facebook" name="facebook" value="<?php echo $row['facebook']; ?>">
                              </div>
                          </div> -->
                          ...
                          <!-- <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter Instagram Url" id="instagram" name="instagram" value="<?php echo $row['instagram']; ?>">
                              </div>
                          </div> -->
                         ...
                         <!--  <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter twitter Url" id="twitter" name="twitter" value="<?php echo $row['twitter']; ?>">
                              </div>
                          </div>
                           ...
                           <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="email" placeholder="Enter email id" id="email" name="email_id" value="<?php echo $row['email_id']; ?>">
                              </div>
                          </div> -->
                           ...
                           <!-- <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter Google+ Url" id="googlep" name="googlep" value="<?php echo $row['googleplus']; ?>">
                              </div>
                          </div> -->
                           ...
                           <!-- <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter linkedin Url" id="linkedin" name="linkedin" value="<?php echo $row['linkedin']; ?>">
                              </div>
                          </div> -->
                         ...
                         <!--  <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter Pinterest Url" id="pinterest" name="pinterest" value="<?php echo $row['pinterest']; ?>">
                              </div>
                          </div> -->
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:61%; height:236px; margin-top:10px;">
                         <img id="img1" src="images/ours_customers_img/<?php echo $row['image']; ?>" alt="" style="width:100%;height:219px;object-fit: cover;">
                       </div>
                 ...
                 <div class="form-content">
                    <div class="row">
                       <div class="col-md-12 unit">
                          ...
                          <div>
                            <textarea class="form-control" rows="5" name="description" placeholder="Enter Description"><?php echo $row['description']; ?></textarea>
                          </div>
                      </div>
                    </div>
                  <!-- end text password -->
