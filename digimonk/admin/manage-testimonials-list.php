...
if(isset($_GET['status_id']))
     {
      ...
      $query="UPDATE testimonial SET status='".$_GET['status']."' WHERE id='".$id."'";
...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">Testimonials list</h2>
        ...
        <div class="widget-wrap  material-table-widget">
            <div class="widget-container margin-top-0">
                <div class="widget-content">
                 ...
                 <?php if(@$_GET['delete']) { ?>
                     <div class="alert alert-success alert-dismissible">
                          <a href="manage-testimonials-list.php" class="close">&times;</a>
              ...
              <?php } ?>
                 ...
                 <div class="col-md-6">
                    <div class="data-align-right">
                        <div class="tbl-action-toolbar">
                            <ul>
                             <li><a href="add-testimonials.php" class="btn add-row btn-info">
                                <i class="fa fa-plus"></i> Add Testimonials</a></li>
                ...
                <?php
                    $query = mysqli_query($conn,"SELECT * FROM testimonial ORDER BY id DESC");
                    $sno = 1;
                ...
                <tr>
                  ...
                  <?php if($row['status']=='0') { ?>
                    <td><a href="manage-testimonials-list.php?status_id=<?php echo $row['id']; ?>&status=1"><button class="btn btn-info"> Active</button></a></td>
                  <?php } else { ?>
                    <td><a href="manage-testimonials-list.php?status_id=<?php echo $row['id']; ?>&status=0"><button class="btn btn-danger"> Deactive</button></a></td>
                  <?php } ?>
                    <td><a href="edit-testimonials.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button></a></td>
