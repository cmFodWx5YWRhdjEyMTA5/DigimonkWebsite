...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Manage Consultant Network</h2>
        ...
        <div class="row">
          ...
          <?php
                $query = mysqli_query($conn,"SELECT * FROM manage_consultant_network");
              ...
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="manage-consultant-network.php" class="close">&times;</a>
                      <strong>Updated</strong> Successfully.
                    </div>
          <?php } ?>
                <div class="row">
                  <form action="update_consultant_network.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_net" value="<?php echo $row['id']; ?>">
                  <div class="col-md-6">
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:100%; height:236px; margin-top:10px;">
                         <img id="img1" src="images/our-value-img/<?php echo $row['3']; ?>" alt="" style="width:100%;height:219px;object-fit: cover;">
                       </div>
