...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Manage Terms and Conditions</h2>
        ...
        <div class="row">
          ...
          <?php
                $query = mysqli_query($conn,"SELECT * FROM terms_conditions");
          ...
          <div class="widget-container">
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="manage-term-and-condition.php" class="close">&times;</a>
              ...
              <?php } ?>
                <div class="row">
                  <form action="update_term_condition.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_term" value="<?php echo $row['id']; ?>">
                  <div class="col-md-6">
