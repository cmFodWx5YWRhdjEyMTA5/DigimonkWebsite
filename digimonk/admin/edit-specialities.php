...
<div class="container-fluid">
        ...
        <div class="row">
         ...
         <?php 
                ...
                $query = mysqli_query($conn,"SELECT * FROM specialities WHERE id='".$id."'");
              ...
              <div class="widget-content">
                ...
                <div class="row">
                  <form action="save_specialities.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_specialities" value="<?php echo $row['id']; ?>">
                        ...
                        <div class="row">
                          <div class="col-md-12 unit">
                           ...
                           <div class="col-md-12 unit">
                              ...
                              <div>
                                  <textarea class="form-control" rows="8" name="description" placeholder="Enter Short Description"><?php echo $row['description']; ?></textarea>
                              </div>
                          </div>
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:100%; height:236px; margin-top:10px;">
                         <img id="output" src="images/specialities_img/<?php echo $row['image']; ?>" alt="" style="width:100%;height:219px;object-fit: cover;">
                       </div>
