...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Update Slider Image</h2>
        ...
        <div class="row">
         ...
         <?php 
                ...
                $query = mysqli_query($conn,"SELECT * FROM slider_img WHERE id='".$id."'");
              ...
              <div class="widget-content">
                ...
                <div class="row">
                  <form action="save_slider_image.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_slider_image" value="<?php echo $row['id']; ?>">
                    <div class="col-md-6">
                     <div class="form-content">
                        <div class="row">
                         ...
                         <div class="col-md-12 unit">
                              <label>Url</label>
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter url" id="url_line" name="url_line" value="<?php echo $row['url_link']; ?>">
                              </div>
                          </div>
                          ...
                          <div class="col-md-12 unit">
                              ...
                              <div>
                                  <textarea class="form-control" rows="5" name="short_description" placeholder="Enter Short Description"><?php echo $row['description']; ?></textarea>
                              </div>
                          </div>
                        </div>
                    </div>
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:100%; height:236px; margin-top:10px;">
                         <img id="img1" src="images/slider_image/<?php echo $row['image']; ?>" alt="" style="width:100%;height:219px;object-fit: contain;">
                       </div>
