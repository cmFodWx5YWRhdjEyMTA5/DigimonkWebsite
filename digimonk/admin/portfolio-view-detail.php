                    ...
                    <div class="col-md-12">
                     <div class="form-content">
                       <div class="row">  </div>
                        <div class="row">
                        	<div class="col-md-5">
                             	<img src="images/project_img/<?php echo $row['image']; ?>" style="width:100%;border: 1px solid #000;padding: 6px;" alt="s">
                            </div>
                      	<div class="col-md-7">
                      	...
                      	<div class="project-details">		
              						<h4>Project Details</h4>	
           							<p><span>Client: </span><?php echo $row['client_name']; ?></p>
    								<!-- <p><span>Location:</span>New York, USA</p>		
          						<p><span>Technology:</span>HTML5 &amp; CSS3, JS, Custom</p> -->		
        						<p><span> Visit Us </span>
                     <a target="_blank" href="<?php echo $row['project_url']; ?>"><?php echo $row['project_url']; ?></a></p>		
          					<!-- 	<p><span>Year Completed:</span>2019</p> -->		
          					</div>
                	</div>
                </div>
                 <div class="row">
                  ...
                  for($i=0; $i<count($get_image); $i++) { 
                    ...
                    ?>
                 	<div class="col-md-3" style="margin-top: 4px;">				
              			<img src="images/project_img/<?php echo @$get_image[$i]; ?>" style="width:100%;border: 1px solid #000;  padding: 8px;  height: 200px;  object-fit: cover;" alt="s">	
        					</div> 
