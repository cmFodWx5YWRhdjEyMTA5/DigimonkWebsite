...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Add Specialities</h2>
        ...
        <div class="row">
          ...
          <div class="widget-container">
              <div class="widget-content">
                 <?php if(@$_GET['save']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="add-specialities.php" class="close">&times;</a>
              ...
              <?php } ?>
                <div class="row">
                  <form action="save_specialities.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12 unit">
                        ...
                        <div>
                            <textarea class="form-control" rows="8" name="description" placeholder="Enter Description"></textarea>
                        </div>
                    </div>
               </div>
                    </div>
             ...
             <div class="col-md-6">
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:100%; height:236px; margin-top:10px;">
                         <img id="output" src="" alt="" style="width:100%;height:219px;object-fit: cover;">
                       </div>
                ...
                <div class="col-md-12">
                      ...
                      <br>
                      <center>
                        <button type="submit" id="btn_submit" class="btn btn-info" name="save">Save</button></center>
                  </div>
                   </div>
             ...
             <div class="col-md-12" style="display: none;">
                 <div class="form-content">
                    <div class="row">
                      <!--  <div class="col-md-12 unit">
                          ...
                          <div>
                            <button id="add_field1" class="btn btn-primary" type="button">Add Field</button>
                          </div>
                      </div> -->
                      ...
                      <div class="col-md-12" id="add_field2" style="display: none;">
                         <div class="row">
                            ...
                            <div>
                               <input type="text" name="clien_name" class="form-control" placeholder="Enter Client name "> 
                            </div>
                          </div>
                          ...
                          <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="url" placeholder="Enter Url" id="url" name="project_url">
                              </div>
                          </div>
                        <div class="col-md-12">
                            <div class="row">
               ...
               <script>
                  ...
                  <!--  <div class="col-md-7">
                      <div class="form-footer">
                      <br>
                      <button type="submit" id="btn_submit" class="btn btn-success primary-btn" name="save">Save</button>
                  </div>
                   </div> -->
                  </div>
                  <!-- end text password -->
