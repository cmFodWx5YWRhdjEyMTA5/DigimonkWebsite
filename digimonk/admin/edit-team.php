        ...
        <div class="row">
         ...
         ?>
          <div class="widget-container">
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="edit-team.php" class="close">&times;</a>
              ...
              <?php } ?>
                <div class="row">
                  <form action="save_team.php" class="j-forms" method="POST" enctype="multipart/form-data">
                     ...
                     <div class="form-content">
                        <div class="row">
                          ...
                          <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="text" placeholder="Enter Designation" id="designation" name="designation" value="<?php echo $row['designation'];?>">
                              </div>
                          </div>
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:61%; height:236px; margin-top:10px;">
                         <img id="img1" src="images/members_img/<?php echo $row['image']; ?>" alt="" style="width:100%;height:219px;object-fit: cover;">
                       </div>
