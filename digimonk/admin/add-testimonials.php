...
<div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="widget-container">
              <div class="widget-content">
                 <?php if(@$_GET['save']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="add-testimonials.php" class="close">&times;</a>
              ...
              <?php } ?>
                <div class="row">
                  <form action="save_testimonials.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <div class="col-md-6">
                     <div class="form-content">
                        <div class="row">
                          ...
                          <div class="col-md-12 unit">
                              ...
                              <div>
                                  <input class="form-control" type="text" placeholder="Enter Designation" id="designation" name="designation" required="">
                              </div>
                          </div>
                        </div>
                    </div>
