...
<div class="container-fluid">
        ...
        <div class="row">
         ...
         <?php
            ...
            $query = mysqli_query($conn,"SELECT * FROM google_analytics_code WHERE id='1'");
              ...
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="google-analytics.php" class="close">&times;</a>
                     ...
                     <div class="form-content">
                        <div class="row">
                          <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="text" placeholder="Enter Page Name" id="page_name" name="page_name" value="<?php echo $row['1']; ?>" readonly>
                              </div>
                          </div>
                            <div class="col-md-6 unit">
                              <label>Google Analytical Code</label>
                              <div>
        <textarea class="form-control" rows="10" name="google_code"><?php echo $row['2']; ?></textarea>
                              </div>
                          </div>
                          <div class="col-md-12">
