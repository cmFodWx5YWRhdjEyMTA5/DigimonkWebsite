...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">Meta Keywords & Description List</h2>
        ...
        <div class="widget-wrap  material-table-widget">
            <div class="widget-container margin-top-0">
                <div class="widget-content">
                 ...
                 <?php if(@$_GET['delete']) { ?>
                     <div class="alert alert-success alert-dismissible">
                          <a href="meta-keywords-list.php" class="close">&times;</a>
              ...
              <?php } ?>
                 ...
                 <div class="col-md-6">
                    <div class="data-align-right">
                        <div class="tbl-action-toolbar">
                            <ul>
                               <li><a id="get_ids_meta_for_delete" class="btn add-row btn-danger">
                ...
                <?php
                     $query = mysqli_query($conn,"SELECT * FROM meta_keywords");
                    $sno = 1;
                ...
                <tr>
                    ...
                    <td><?php echo $row['mete_keywords']; ?></td>
                    <td><?php echo $row['meta_description']; ?></td>
                    <td><?php echo $row['date']; ?></td>
                    <td><a href="manage-meta-keywords.php?id=<?php echo $row['id']; ?>">
