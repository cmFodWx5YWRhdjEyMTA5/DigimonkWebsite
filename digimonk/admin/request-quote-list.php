...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">Request Quote list</h2>
                ...
                <div class="widget-content">
                            ...
                            <div class="col-md-6">
                                <?php if(@$_GET['delete']) { ?>
                                 <div class="alert alert-success alert-dismissible">
                                      <a href="request-quote-list.php" class="close">&times;</a>
                 ...
                 <div class="col-md-6">
                         ...
                         <ul>
                             <li>
                                <a href="#" class="btn btn-info dropdown-toggle" onclick="$('#exportable-tbl').tableExport({type:'excel',escape:'false'});">
                                    <i class="fa fa-file-excel-o"></i> XLS File <i class="fa fa-download"></i> 
                                </a>
                            ...
                            <li><a id="get_request_ids_for_delete" class="btn add-row btn-danger">
                    ...
                    <table id="exportable-tbl" class="table table-striped data-tbl">
                        ...
                        <?php
                            $contact_query = mysqli_query($conn,"SELECT * FROM request_quote ORDER BY id DESC");
                            $sno = 1;
