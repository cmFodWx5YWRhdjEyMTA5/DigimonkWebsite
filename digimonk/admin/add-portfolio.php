...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Add Portfolio</h2>
              ...
              <div class="widget-content">
                 <?php if(@$_GET['save']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="add-portfolio.php" class="close">&times;</a>
                          ...
                          <div class="col-md-12 unit">
                              ...
                              <div>
                                 <select class="form-control" name="types_application">
                                   <option value="" selected="" disabled="">Select Type Application</option>
                      ...
                      <div class="col-md-12" id="add_field2" style="display: none;">
                         <div class="row">
                          ...
                          <div class="col-md-6 unit">
                              ...
                              <div>
                                  <textarea class="form-control" name="technology_part" placeholder="Enter Technology"></textarea>
                              </div>
                          </div>
                          ...
                          <!-- <div class="col-md-6 unit">
                              ...
                              <div>
                                  <input class="form-control" type="text" placeholder="Enter Project complete date" id="complete_date" name="complete_date">
                              </div>
                          </div> -->
                        <div class="col-md-12">
                            <div class="row">
