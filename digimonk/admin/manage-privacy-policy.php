...
<div class="container-fluid">
        <div class="page-header filled full-block light">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="text-center">Manage Privacy Policy</h2>
        ...
        <div class="row">
          ...
          <?php
                $query = mysqli_query($conn,"SELECT * FROM privacy_policy");
          ...
          <div class="widget-container">
              <div class="widget-content">
                 <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="manage-privacy-policy.php" class="close">&times;</a>
              ...
              <?php } ?>
                <div class="row">
                  <form action="update_privacy_policy.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_privacy" value="<?php echo $row['id']; ?>">
                  <div class="col-md-6">
