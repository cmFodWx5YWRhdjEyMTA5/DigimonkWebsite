              ...
              <div class="widget-content">
                ...
                <div class="row">
                  <form action="save_event.php" class="j-forms" method="POST" enctype="multipart/form-data">
                    <input type="hidden" name="update_event" value="<?php echo $row['id']; ?>">
                   ...
                   <label class="label text-center">Image</label> 
                    <div class="col-md-12"> 
                      <div class="form-control" style="width:100%; height:236px; margin-top:10px;">
                         <img id="output" src="images/event_gallery_img/<?php echo $row['image']; ?>" alt="" style="width:100%;height:219px;object-fit:contain;">
                       </div>
               ...
               <div class="fdj remove_image_gm kiop">
                 <input type="hidden" name="old_image[]" value="<?php echo @$get_image[$i]; ?>">
                  ...
                  <span><i class="fa fa-times remove-img"></i></span>
                    <img src="images/event_gallery_img/<?php echo @$get_image[$i]; ?>" style="width:250px;">
             </div>
         </div>
