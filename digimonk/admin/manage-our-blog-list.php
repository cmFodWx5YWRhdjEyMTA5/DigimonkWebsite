<?php include('include/header.php'); 
    ...
    if(isset($_GET['status_id']))
    {
      ...
      $update_query = mysqli_query($conn,"UPDATE our_blog SET status='".$_GET['status']."' WHERE id='".$id."'");
    }
?>
...
<div class="page-header filled full-block light">
    <div class="row">
        <div class="col-md-12">
            <h2 class="text-center">Our Blogs list</h2>
            ...
            <div class="widget-container margin-top-0">
                <div class="widget-content">
                   ...
                   <div class="alert alert-success sequece_updated" style="display: none;">
                      <a href="manage-our-blog-list.php" class="close">&times;</a>
              ...
              <?php } ?>
                            ...
                            <ul>
                              <li><a href="javascript:;" class="btn add-row btn-primary" id="sequence_update">
                                <i class="fa fa-list"></i> Update Sequence</a>
                                  <input type="hidden" id="types_set_dsp" value="blogs">
                              </li>
                             <li><a href="add-our-blog.php" class="btn add-row btn-info">
                                <i class="fa fa-plus"></i> Add Blog</a></li>
                               <li><a id="get_blog_ids_for_delete" class="btn add-row btn-danger">
                ...
                <?php
                    $query = mysqli_query($conn,"SELECT * FROM our_blog ORDER BY priority ASC");
                    $sno = 1;
                    ...
                    <td>
                      ...
                      <td class="td-center">
                        <a href="#" class="td-profile-thumb">
                            <img src="images/our_blog_img/<?php echo $row['image']; ?>" alt="image">
                        </a>
                    </td>
                    <td><?php echo $row['heading']; ?></td>
                    <!-- <td><?php echo $row['title']; ?></td> -->
                    <td><a href="blog-view-detail.php?view_id=<?php echo $row['id']; ?>" target="_blank">Click View Description</a></td>
                    <td><?php echo $row['date_time']; ?></td>

                     <?php if($row['status']=='0'){ ?>

                      <td><a href="manage-our-blog-list.php?status_id=<?php echo $row['id']; ?>&status=1">
                      <button class="btn btn-danger"><i class="fa fa-eye-slash"></i>  Deactive</button>
                       </a>
                     </td>
                     
               <?php } else { ?>
                    <td><a href="manage-our-blog-list.php?status_id=<?php echo $row['id']; ?>&status=0">
                  ...
                  <?php } ?>
                    ...
                    <td><a href="edit-our-blog.php?id=<?php echo $row['id']; ?>"><button class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button></a></td>
