            ...
            <div class="widget-container margin-top-0">
                <div class="widget-content">
                 ...
                 <?php if(@$_GET['delete']) { ?>
                     <div class="alert alert-success alert-dismissible">
                          <a href="faq-list.php" class="close">&times;</a>
                ...
                <?php } ?>
                  ...
                  <?php if(@$_GET['update']) { ?>
                    <div class="alert alert-success alert-dismissible">
                      <a href="faq-list.php" class="close">&times;</a>
                      <strong>Faq Updated</strong> Successfully.
                    </div>
              <?php } ?>
              ...
              <?php } ?>
                 ...
                 <div class="col-md-6">
                    <div class="data-align-right">
                        <div class="tbl-action-toolbar">
                            <ul>
                              <li><a href="add-faq.php" class="btn add-row btn-primary">
                                <i class="fa fa-plus"></i> Add Faq ?</a></li>

                               <li><a id="get_ids_faq_for_delete" class="btn add-row btn-danger">
                ...
                <tr>
                    <td><input type="checkbox" class="checkitem" name="cagree[]" value="<?php echo $row['id'];?>" data-error=".errorTxt9"></td>
                     ...
                     <td><a href="edit-faq.php?id=<?php echo $row['id']; ?>">
